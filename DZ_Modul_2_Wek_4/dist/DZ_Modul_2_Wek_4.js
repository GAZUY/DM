...
var Cartridge = /** @class */ (function () {
    function Cartridge(color, amountOfInk) {
        this.color = color;
        this.amountOfInk = amountOfInk;
    }
    Cartridge.prototype.display = function (str) {
        var arr = str.split(' ').join('');
        //console.log (arr)
    };
    return Cartridge;
}());
var a = new Cartridge('red', 50);
a.display('Реализуйте класс ExtendedDate, унаследовав его от стандарт');
console.log(a);
/*
Задание 2
